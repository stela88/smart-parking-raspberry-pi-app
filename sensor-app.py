    ...
    while True:
        ...
        if distance_first_sensor <= 8:
            ...
            response_get = requests.get(
                f'http://172.16.1.18:8082/api/tickets/registration/{most_common_reg}'
            )
            if (response_get.status_code != 200):
                ...
                response_create = requests.post(
                    'http://172.16.1.18:8082/api/tickets',
                ...
                response_transactions = requests.get(
                    f'http://172.16.1.18:8082/api/transactions'
                )
        ...
        if distance_second_sensor <= 8:
            ...
            response2 = requests.get(
                f'http://172.16.1.18:8082/api/tickets/registration/{most_common_reg}/can-exit',
                json={'registration': most_common_reg}
            )
            ...
            if result2 == True:
                ...
                response = requests.post(
                    f'http://172.16.1.18:8082/api/tickets/registration/{most_common_reg}/exit',
